...
#define  OQS_NAMESPACE_CRYPTO_CIPHERTEXTBYTES GENERATOR_CRYPTO_CIPHERTEXTBYTES     // [(P+DIGIT_b-1)/DIGIT_b]]*DIGIT_SIZE_B+PQCLEAN_LEDACRYPTXXXX_CLEAN_CRYPTO_RANDOMBYTES)
